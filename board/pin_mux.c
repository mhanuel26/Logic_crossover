...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_11_FLEXIO1_IO03,         	  /* GPIO_AD_14 is configured as FLEXIO1_IO26 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  ...
  IOMUXC_SetPinMux(
    ...
    IOMUXC_SetPinConfig(
		IOMUXC_GPIO_09_FLEXIO1_IO01,             /* GPIO_09 PAD functional properties : */
        0x10A0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/4
                                                   Speed Field: fast(150MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
    ...
    IOMUXC_SetPinConfig(
        ...
        0x10A0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinConfig(
  	  IOMUXC_GPIO_11_FLEXIO1_IO03,         /* GPIO_AD_14 PAD functional properties : */
        0x10A0U);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/4
                                                   Speed Field: fast(150MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
